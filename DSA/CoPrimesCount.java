...
class CoPrimesCount 
{
    static final int MAX = 10001;                                 // as per gfg constraints
    ...
    {
        CoPrimesCount sol = new CoPrimesCount();
        int[] arr1 = {1, 2, 3};
        int[] arr2 = {4, 8, 3, 9};
        int[] arr3 = {15, 8, 19, 2, 13, 18, 11, 20, 20, 5};

        System.out.println(sol.cntCoprime(arr1));  
        System.out.println(sol.cntCoprime(arr2));  
        System.out.println(sol.cntCoprime(arr3));  
    }
}